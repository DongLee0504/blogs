...
- 使用场景：vue渲染比较大的数据，而且这些数据只做展示，不做修改（图表的展示，table展示），使用 `Object.freeze` 可以优化渲染，减少加载时间
- 在线测速demo [点我](https://panjiachen.gitee.io/panjiachen.github.io/big-table/index.html#optimized)
